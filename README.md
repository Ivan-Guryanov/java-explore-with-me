...
<span style="color: #2ea44f; font-weight: bold;">   │   │</span>
<span style="color: #cf222e; font-weight: bold;">   │   ├── stats-client (Библиотека-клиент для Main Service)</span>
<span style="color: #2ea44f; font-weight: bold;">   │   │   ├── pom.xml (Зависит от stats-dto)</span>
<span style="color: #cf222e; font-weight: bold;">   │   │   └── src/main/java/ru/practicum/explore/client</span>
<span style="color: #cf222e; font-weight: bold;">   │   │       └── StatsClient.java (Методы hit() и getStats() через RestTemplate)</span>
<span style="color: #cf222e; font-weight: bold;">   │   │</span>
<span style="color: #0969da; font-weight: bold;">   │   └── stats-server (Сервер сбора и хранения данных)</span>
<span style="color: #2ea44f; font-weight: bold;">   │       ├── pom.xml (Зависит от stats-dto)</span>
<span style="color: #0969da; font-weight: bold;">   │       ├── src/main/java/ru/practicum/explore/stats</span>
<span style="color: #0969da; font-weight: bold;">   │       │   ├── StatsController.java</span>
<span style="color: #0969da; font-weight: bold;">   │       │   │   ├── POST /hit (Регистрация просмотра)</span>
<span style="color: #0969da; font-weight: bold;">   │       │   │   └── GET /stats (Получение статистики: start, end, uris, unique)</span>
<span style="color: #0969da; font-weight: bold;">   │       │   ├── EndpointHitMapper.java</span>
<span style="color: #0969da; font-weight: bold;">   │       │   ├── EndpointHit.java (@Entity)</span>
<span style="color: #0969da; font-weight: bold;">   │       │   ├── StatsRepository.java (Native/JPQL Query для агрегации)</span>
<span style="color: #0969da; font-weight: bold;">   │       │   └── StatsServiceImpl.java</span>
